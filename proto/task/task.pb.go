...
func (x *CreateTaskRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
const file_proto_task_task_proto_rawDesc = "" +
	...
	"\tListTasks\x12\x16.task.ListTasksRequest\x1a\x17.task.ListTasksResponseB1Z/github.com/paytelenko/project-protos/proto/taskb\x06proto3"
...
var file_proto_task_task_proto_depIdxs = []int32{
	...
	7, // 7: task.TaskService.ListTasks:input_type -> task.ListTasksRequest
